...
mod tests {
    ...
    fn nointro_region_parses() {
        assert_eq!(
            Region::from_region_string("USA, Europe"),
            vec![Region::UnitedStates, Region::Europe]
        );
    }
    ...
    fn nointro_region_parses_many() {
        assert_eq!(
            Region::try_from_nointro_region("Japan, Europe, Australia, New Zealand").unwrap(),
            vec![
                Region::Japan,
                Region::Europe,
                Region::Australia,
    ...
    fn tosec_region_parses() {
        ...
        assert_eq!(
            Region::from_region_string("US-ZZ"),
    ...
    fn nointro_filename_parses() {
        let parsed: NameInfo =
            NoIntroName::try_parse("Cube CD 20, The (40) - Testing (Europe) (Unl)")
                .unwrap()
                .into();
    ...
    fn nointro_filename_parses_2() {
        let parsed: NameInfo =
            NoIntroName::try_parse("Star Jacker (Japan, Europe, Australia, New Zealand) (Rev 1)")
                .unwrap()
                .into();
    ...
    fn nointro_filename_parses_odekake() {
        let parsed: NameInfo = NoIntroName::try_parse("Odekake Lester - Lelele no Le (^^; (Japan)")
            .unwrap()
            .into();
    ...
    fn nointro_filename_parses_end() {
        let parsed: NameInfo =
            NoIntroName::try_parse("Cube CD 20, The (40) - Testing (Europe) (Rev 10)")
                .unwrap()
                .into();
        assert_eq!("Cube CD 20, The (40) - Testing", parsed.entry_title());
        assert_eq!("The Cube CD 20 (40): Testing", parsed.release_title());
    ...
    fn tosec_filename_parses() {
        let parsed: NameInfo =
            TOSECName::try_parse("Cube CD 20, The (40) - Testing (demo) (2020)(SomePublisher)(US)")
                .unwrap()
                .into();
        assert_eq!("Cube CD 20, The (40) - Testing", parsed.entry_title());
        assert_eq!("The Cube CD 20 (40): Testing", parsed.release_title());
    ...
    fn tosec_filename_parses_2() {
        let parsed: NameInfo = TOSECName::try_parse(
    ...
    fn tosec_filename_parses_4() {
        let parsed: NameInfo =
            TOSECName::try_parse("Bombsawa (Jumpman Selected levels)(19XX)(-)(PD)")
                .unwrap()
                .into();
    ...
    fn tosec_filename_parses_6() {
        let parsed: NameInfo =
            TOSECName::try_parse("256 Color Demo (1997)(Schick, Bastian)(PD)[a]")
                .unwrap()
                .into();
    ...
    fn tosec_filename_parses_end() {
        let parsed: NameInfo = TOSECName::try_parse(
            "Cube CD 20, The (40) - Testing v1.203 (demo) (2020)(SomePublisher)",
        )
        .unwrap()
        .into();
        assert_eq!("Cube CD 20, The (40) - Testing", parsed.entry_title());
    ...
    fn tosec_filename_parses_end_rev() {
        let parsed: NameInfo = TOSECName::try_parse(
            "Cube CD 20, The (40) - Testing Rev 1 (demo) (2020)(SomePublisher)",
        )
        .unwrap()
        .into();
        assert_eq!("Cube CD 20, The (40) - Testing", parsed.entry_title());
